...
alias cbuild='autoninja -C out/Release content_shell'
alias clayout='python third_party/blink/tools/run_web_tests.py -t Release'
alias crbuild='autoninja -C out/Release chrome'
alias crflash='./out/Release/chrome --ozone-platform=wayland'
...
alias cdebuggdb='gdb --tui --args out/Default/content_shell --single-process'
...
alias waglflash='sudo qemu-system-x86_64 -enable-kvm -m 2048 -hda ../build/tmp/deploy/images/qemux86-64/agl-whale-demo-platform-qemux86-64.wic.v'
alias wenvsetup='source build/android/envsetup.sh'
alias wbuild='autoninja -C out/default whale_public_apk'
...
alias xbuild='autoninja -C out/Release xwalk_core_library xwalk_core_shell_apk && cp -r out/Release/xwalk_core_library/libs ~/Projects/naverapp/Search/lib/crosswalkwebview'
alias xbuild2='autoninja -C out/Release xwhale_android_library xwhale_instrumentation_apk'
...
alias xstack='./out/Release/bin/stack_xwalk_core_shell_apk'
alias xflash='out/Release/bin/xwalk_core_shell_apk install && out/Release/bin/xwalk_core_shell_apk launch'
...
export PATH=/usr/lib/icecc/bin:$HOME/Projects/chromium/src/third_party/llvm-build/Release+Asserts/bin:$PATH:$HOME/Workspace/android-sdks/tools:$HOME/Workspace/android-sdks/platform-tools:$HOME/Workspace/depot_tools:$HOME/Workspace/apktool:$HOME/Workspace/dex2jar
...
export ICECC_VERSION=$HOME/Workspace/m80clang.tar.gz
